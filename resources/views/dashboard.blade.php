        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                ...
                <div class="row mt-5">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">Revenue Insights</div>
                            <div class="card-body">
                                <div id="chart-revenue-bg"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
...
document.addEventListener("DOMContentLoaded", function () {
    const charts = [
        { id: 'chart-revenue-bg', type: 'area', data: [37, 35, 44, 28, 36, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46, 39, 62, 51, 35, 41, 67] },
        { id: 'chart-new-clients', type: 'line', data: [37, 35, 44, 28, 36, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 4, 46, 39, 62, 51, 35, 41, 67] },
        { id: 'chart-active-users', type: 'bar', data: [37, 35, 44, 28, 36, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46, 39, 62, 51, 35, 41, 67] },
    ];
    ...
    charts.forEach(chart => {
        ...
        const apexChart = new ApexCharts(el, {
            chart: {
                type: chart.type,
                fontFamily: 'inherit',
            ...
            fill: {
                opacity: chart.type === 'area' ? 0.16 : 1,
            },
            stroke: {
                width: 2,
                curve: 'smooth',
