                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- Show the actual image of the product --}}
                            {{-- @if ($product->product_image)
                                <img class="img-account-profile mb-2" src="{{ asset('storage/' . $product->product_image) }}" alt="{{ $product->name }}" id="image-preview" />
                            @else
                                <img class="img-account-profile mb-2" src="{{ asset('assets/img/products/default.webp') }}" alt="{{ $product->name }}" id="image-preview" />
                            @endif --}}
                            @if ($product->product_image)
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered card-table table-vcenter text-nowrap datatable">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Buying Price</td>
                                        <td>{{ format_currency($product->buying_price) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Selling Price</td>
