...
class ProductController extends Controller
{
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
        ...
        if ($request->hasFile('product_image')) {
            ...
            // Delete Old Photo
            //check if there any old photo exists
            // If exists, delete it
            // This is to prevent errors if the file does not exist
            // when trying to delete the old photo
            // Check if the product has an image
            // and unlink it from the storage
